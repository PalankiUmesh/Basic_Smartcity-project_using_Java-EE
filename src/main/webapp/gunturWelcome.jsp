...
<head>
  ...
  <style>
    ...
    /* drop-down menu
            ...
            /* Basic styling for the drop-down menu */
        .dropdown {
            position: relative;
            display: inline-block;
        }

        /* Style for the clickable text/button that opens the drop-down */
        .dropdown-btn {
        ...
        /* Style for the links inside the drop-down */
        .dropdown-content a {
            display: block;
            padding: 10px;
        ...
        /* Hover effect for the links inside the drop-down */
        .dropdown-content a:hover {
            background-color: #ddd;
        }

        /* Show the drop-down content when the drop-down button is hovered */
    ...
    .intro {
      ...
      width: 100%;
      height: 520px;
      background: linear-gradient(to bottom, rgba(0, 0, 0, 0.5) 0%, rgba(0, 0, 0, 0.5) 100%), url("https://media.giphy.com/media/eKsQ8QekTjovzsiujQ/giphy.gif");
...
<body>
  <header class="header">
    ...
    <nav class="nav-items">
      ...
      <a href="gunturHospital.jsp">Health Care</a>
      <p>Guntur
    </nav>
  </header>
  <main>
